...
st.write("若干年前，我们都在校园里，为Tripos奋斗，为明天感到迷茫，为拿一份工作的Offer操碎了心；今天的我们都在英国或是世界的其他地方扎下了小小的一步脚印，并在这里重聚。无论你是在学术圈燃烧自己的青春和头发，还是身为社畜为社会做着绵薄的贡献，你还记得当初踏入校园或是初入社会时的初心吗？明天呢，你对明天有什么憧憬，5年之后你又希望成为什么样的人，过着什么样的生活呢？")

st.write("我们希望在这次以“时光”为主题的活动上尽一些自己小小的努力。请在这里留下你想对五年之后的自己说的话，剑桥华人校友会将于五年之后的2027年9月23日准时将以下的信息发到你提供的邮箱里。连同我们现在留下的，对未来的大家小小的祝福")
st.write('Love')
